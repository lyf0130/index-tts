...
parser.add_argument("--port", type=int, default=7890, help="Port to run the web UI on")
...
# ⚠️ 仅用于本地开发，禁用 "只能访问上传目录" 的限制
def _no_check_allowed(path, check_in_upload_folder=True):
    return  # 直接放行


gr_proc._check_allowed = _no_check_allowed
...
<a href='https://arxiv.org/abs/2506.21619'><img src='https://img.shields.io/badge/ArXiv-2506.21619-red'></a>
    ...
    with gr.Tab(i18n("音频生成")):
        ...
        # 术语词汇表管理
        with gr.Accordion(i18n("自定义术语词汇读音"), open=False,
